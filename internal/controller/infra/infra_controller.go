...
//+kubebuilder:rbac:groups=xdpin.cn,resources=infras,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=xdpin.cn,resources=infras/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=xdpin.cn,resources=infras/finalizers,verbs=update
