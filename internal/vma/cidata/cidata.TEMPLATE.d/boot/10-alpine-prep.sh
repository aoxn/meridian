...
# This script prepares Alpine for md; there is nothing in here for other distros
...
usermod -p '*' "${MD_CIDATA_USER}"

# Alpine disables TCP forwarding, which is needed by the md-guestagent
...
# `mdctl stop` tells acpid to powerdown
rc-update add acpid
