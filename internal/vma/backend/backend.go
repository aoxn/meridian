...
type Driver interface {
	...
	// Register will add an instance to a generic.
	...
	// Dialer returns the guest agent connection, or nil (if forwarded by ssh).
	Dialer(_ context.Context) (dialer.Dialer, error)
}

type BaseDriver struct {
	I    *model.Instance
	Yaml *v1.VirtualMachine
...
func (d *BaseDriver) Dialer(_ context.Context) (dialer.Dialer, error) {
	return nil, nil
}
